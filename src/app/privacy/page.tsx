  ...
  return (
    <div>
      <div>
        ...
        <p className="mt-2 text-sm text-text-quaternary">최종 수정: 2026년 2월 13일</p>
      </div>

      <div className="mt-8 space-y-6 text-[15px] leading-relaxed text-text-secondary">
        <section>
          <h2 className="mb-2 text-lg font-semibold text-text-primary">1. 수집하는 정보</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-text-primary">2. 쿠키 및 광고</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-text-primary">3. 분석 도구</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-text-primary">4. 제3자 링크</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-text-primary">5. 데이터 저장 및 삭제</h2>
          <p>모든 퀘스트 진행 데이터는 사용자의 브라우저 localStorage에 저장됩니다. 브라우저의 사이트 데이터를 삭제하거나, 프로필 페이지의 &quot;진행도 초기화&quot; 버튼을 통해 언제든 삭제할 수 있습니다.</p>
        </section>

        <section>
          <h2 className="mb-2 text-lg font-semibold text-text-primary">6. 면책조항</h2>
          <p>코인던전은 교육 목적의 서비스이며, 투자 조언을 제공하지 않습니다. 암호화폐 투자는 높은 위험을 수반하며, 모든 투자 결정은 사용자 본인의 책임입니다.</p>
        </section>

        <section>
          <h2 className="mb-2 text-lg font-semibold text-text-primary">7. 변경 사항</h2>
          <p>본 개인정보처리방침은 서비스 변경에 따라 수정될 수 있으며, 변경 시 이 페이지를 통해 공지합니다.</p>
        </section>

        <section>
          <h2 className="mb-2 text-lg font-semibold text-text-primary">8. 문의</h2>
